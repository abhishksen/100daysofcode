...
Finally completed the react-router-dom project

check it out [here](https://vanlyf.netlify.app/)

learnt a lot about react-router-dom, routes, browserRouter, router, routerProvider, nested routes, useNavigate, useParams and so on.
